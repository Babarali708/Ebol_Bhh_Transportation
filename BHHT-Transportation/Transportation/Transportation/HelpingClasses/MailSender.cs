    ...
    public class MailSender
    {
        ...
        public async Task<bool> SendForgotPasswordEmailAsync(string email, string id, string BaseUrl = "")
        {
            try
            {
                ...
                message.From.Add(new MailboxAddress("Ebol Transportation", projectVariables.FromEmail));
                message.To.Add(new MailboxAddress("Ebol Transportation", email));
                message.Subject = "Ebol Transportation | Forgot Password";
